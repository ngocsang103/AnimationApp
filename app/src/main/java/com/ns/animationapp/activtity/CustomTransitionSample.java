...
import com.ns.mylibrary.TransitionValues;
import com.ns.mylibrary.utils.IntProperty;
...
public class CustomTransitionSample extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.flag_customer, container, false);

        mTransitionsContainer = (ViewGroup) view.findViewById(R.id.transitions_container);
        mProgressBar = (ProgressBar) view.findViewById(R.id.pbProgressBar);

        view.findViewById(R.id.btnButton1).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setProgress(mProgressBar.getProgress() - 20);
            }
        });
        view.findViewById(R.id.btnButton2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
